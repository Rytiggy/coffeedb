...
CREATE TABLE `authorship` (
  ...
  CONSTRAINT `fk_a_p` FOREIGN KEY (`paperId`) REFERENCES `papers` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_role` VALUES (1,1),(2,1),(3,2),(4,3),(5,2),(6,1);
...
CREATE TABLE `paper_keywords` (
  ...
  KEY `pk_p` (`id`),
  CONSTRAINT `pk_p` FOREIGN KEY (`id`) REFERENCES `papers` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
