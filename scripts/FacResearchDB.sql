...
--
CREATE TABLE `users` ( `UserName` VARCHAR(256) NOT NULL , `Password` VARCHAR(256) NOT NULL , `Name` VARCHAR(256) NOT NULL , `Access` VARCHAR(256) NOT NULL DEFAULT 'student, facility' ) ENGINE = InnoDB; 
INSERT INTO `users`(`UserName`, `Password`, `Name`, `Access`) VALUES ('student', 'password', 'student', 'student'),('facility', 'password', 'facility', 'facility') 
